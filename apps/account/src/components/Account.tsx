	...
	const handleDeleteData = async () => {
		...
		try {
			...
			toast({
				type: 'success',
				title: 'Data Deleted',
				description: 'Your profile data has been successfully reset.',
			});
	...
	return (
		...
		>
			...
			>
				...
				<p className="text-sm text-(--text-muted)">{t('account.account.description')}</p>
			</div>
			...
			>
				...
				>
					...
					>
						<h3 className="text-base font-semibold text-(--text)">{t('account.account.session.title')}</h3>
						<p className="text-xs text-(--text-muted)">{t('account.account.session.description')}</p>
					</div>
					<button
					...
					>
						<LogOut size={16} />
						<span>{t('account.account.session.button')}</span>
					</button>
				</div>
				...
				>
					...
					>
						<div
							className="flex items-center text-(--text) font-semibold text-base"
							style={{
								gap: 'calc(var(--ui-gap) * 0.5)',
							}}
						>
							<Settings size={18} />
							<h3>{t('account.common.title')}</h3>
						</div>
						<div className="flex items-center gap-1 text-xs text-(--text-muted)">
							{t('account.common.description2')}
							<div className="group relative flex items-center">
								...
								>
									<p className="font-semibold text-(--text) mb-1.5">{t('account.profile.privacy.tooltip.title')}</p>
									<ul className="space-y-1.5">
										<li>
											<span className="font-medium text-(--text)">{t('account.profile.privacy.tooltip.privateTitle')}</span> {t('account.profile.privacy.tooltip.privateDesc')}
										</li>
										<li>
											<span className="font-medium text-(--text)">{t('account.profile.privacy.tooltip.limitedTitle')}</span> {t('account.profile.privacy.tooltip.limitedDesc')}
										</li>
										<li>
											<span className="font-medium text-(--text)">{t('account.profile.privacy.tooltip.publicTitle')}</span> {t('account.profile.privacy.tooltip.publicDesc')}
										</li>
									</ul>
								</div>
							</div>
				...
				>
					...
					>
						<div
							className="flex items-center text-(--accent-orange) font-semibold text-base"
							style={{
								gap: 'calc(var(--ui-gap) * 0.5)',
							}}
						>
							<AlertTriangle size={18} />
							<h3>{t('account.common.title2')}</h3>
						</div>
						<p className="text-xs text-(--accent-orange)/80">{t('account.common.description3')}</p>
					</div>
					<button
					...
					>
						<Trash2 size={16} />
						<span>{t('account.common.description4')}</span>
					</button>
				</div>
				...
				>
					...
					>
						<div
							className="flex items-center text-(--accent-red) font-semibold text-base"
							style={{
								gap: 'calc(var(--ui-gap) * 0.5)',
							}}
						>
							<AlertTriangle size={18} />
							<h3>{t('account.account.danger.title')}</h3>
						</div>
						<p className="text-xs text-(--accent-red)/80">{t('account.account.danger.description')}</p>
					</div>
					<button
					...
					>
						<Trash2 size={16} />
						<span>{t('account.common.description5')}</span>
					</button>
				</div>
			</div>
			...
			<Confirm
				...
				title={t('account.account.danger.confirmTitle')}
				description={t('account.account.danger.confirmDescription')}
				confirmText={t('account.account.danger.confirmButton')}
			...
			<Confirm
				...
				title={t('account.common.tooltip')}
