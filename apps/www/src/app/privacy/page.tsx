...
export default function Page() {
	...
	const sections: Section[] = [
		...
		},
		{
			...
			content: (
				<p>{t('www.privacy.sections.legalBasis.content', {}, 'We process personal data based on contractual necessity, legitimate interests, legal obligations, or user consent where applicable.')}</p>
			),
		},
		{
			id: 'usage',
		...
		},
		{
			...
			content: (
				<p>
					{t('www.privacy.sections.retention.content', {}, 'We retain data only as long as necessary to fulfill the purposes outlined in this Policy, unless longer retention is required by law.')}
				</p>
			),
		},
		{
		...
		},
		{
			...
			content: <p>{t('www.privacy.sections.international.content', {}, 'If data is transferred outside your jurisdiction, appropriate safeguards are implemented to ensure legal compliance.')}</p>,
		},
		{
			id: 'changes',
