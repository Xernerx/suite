		...
		<motion.footer initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="relative w-full overflow-hidden bg-(--background) backdrop-blur-md">
			...
			<div className="mx-auto grid w-full max-w-[1400px] grid-cols-1 gap-10 px-8 py-12 md:grid-cols-[1.6fr_1fr_1fr] md:px-12">
				...
				<FooterSection title="Resources">
					<FooterLink href={getEnvUrl('https://xernerx.com/privacy')} icon={Shield} label="Privacy" external={false} />
					<FooterLink href={getEnvUrl('https://xernerx.com/terms')} icon={FileText} label="Terms" external={false} />
					<FooterLink href={getEnvUrl('https://xernerx.com/contact')} icon={Mail} label="Contact" external={false} />
				</FooterSection>
				{/* ---------------------------------------------------------------- */}
				{/* Developer */}
				{/* ---------------------------------------------------------------- */}
