...
export function NotFound() {
	...
	return (
		<div className="flex min-h-screen w-full flex-col items-center justify-center overflow-hidden px-6 font-sans">
			<div className="relative z-10 flex flex-col items-center text-center">
				...
				<motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.8, ease: [0.16, 1, 0.3, 1] }}>
					<div className="mb-6 inline-flex items-center gap-2.5 rounded-full border border-(--border)/40 bg-(--background)/50 px-3 py-1.5 shadow-sm backdrop-blur-md">
					...
					<h1 className="mb-4 text-3xl font-extrabold tracking-tight text-(--text) md:text-5xl">Signal Lost.</h1>

					<p className="mx-auto mb-10 max-w-sm text-base leading-relaxed text-(--text-muted)">The resource you requested cannot be located in the current routing manifest.</p>
				</motion.div>
